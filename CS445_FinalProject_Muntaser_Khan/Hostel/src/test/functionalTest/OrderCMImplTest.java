...
import Hostel21.*;
	 ...
	 * @author Amanda
	 */
	public class OrderCMImplTest implements Order {
	    private static final String FILE_NAME = "orderTest.txt";
	    @Override
	    ...
	    public static void main(String[] args) {
			Order mainDM = new OrderCMImplTest();
			
	                OrderModel order=new OrderModel();
	                order.setOrderid("1");
	                order.setDateCreate(20120404);
	                order.setUserid("1");
	                order.setStatus(1);
	                mainDM.create(order);
			System.out.println(mainDM.getAll());
			//System.out.println(detailDM.getAll());
		}
